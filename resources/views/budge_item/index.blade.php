...
@section('content')
    ...
    <div class="row justify-content-center">
                ...
                <div class="card-header card-calendar">
                    ...
                    <h4 class="card-title ">
                        ...
                        <small class="float-sm-right">
                            ...
                            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#BudgeItemModal" data-json="null" > Nuevo  <i class="fa fa-plus-circle"></i> </button>
                        </small>
                    </h4>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#BudgeItemModal" data-json="{{$item}}"><i class="material-icons text-primary">edit</i></a>
        ...
        {{-- aqui los modals --}}
        <budge-item-component url='{{url('budge_item')}}' csrf='{!! csrf_field('POST') !!}'></budge-item-component>
    ...
    @section('script')
        ...
        function deleteItem(){
            ...
            if (result.value) {
                ...
                axios.delete(`budge_item/${data.id}`)
                    .then(response=>{
